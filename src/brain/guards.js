...
const INJECTION_PATTERNS = [
  ...
  // Arabic prompt-injection variants:
  /تجاهل (?:جميع |كل |أي )?(?:التعليمات|الأوامر|التوجيهات|القواعد|الموجهات)(?: السابقة| الأولى)?/i,
  /تجاهل (?:الموجه|الأوامر|النظام)/i,
  /انس(?:َ|ى|ي)? (?:كل |جميع )?(?:ما سبق|التعليمات|التوجيهات|الأوامر)/i,
  /أنت الآن (?:DAN|بلا قيود|وضع المطور|جيلبريك)/i,
  /تصرف كـ[^.]{0,30}(?:وضع المطور|بلا قيود|جيلبريك)/i,
  /تظاهر بأنك/i,
  /(?:اعرض|أظهر|اطبع|كرر|أخرج|أخبرني بـ?) (?:التعليمات|الموجه|الموجهات|التعليمات النظامية)/i,
  /ما هي (?:التعليمات|الموجهات|الأوامر) (?:الأساسية|النظامية|الأولى|الأصلية)/i,
  /تجاوز (?:التعليمات|القواعد|النظام)/i,
];
